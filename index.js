class Stlightbox {
    ...
    createGalleryControls() {
        ...
        this.addElementClass(galleryControls, 'stlightbox-gallery__controls', 'gallery-controls');
    ...
    createPagination() {
        ...
        const total = this.currentLightboxGroup.length;
    ...
    dropGallery() {
        const galleryOverlay = document.querySelector('.stlightbox');
        galleryOverlay.style.opacity = '0';
            ...
            link.addEventListener('click', (e) => {
                ...
                if (galleryOverlay) {
                    galleryOverlay.addEventListener('click', (e) => {
                        if (e.target.classList.contains('stlightbox-gallery')) {
                            this.dropGallery();
                        }
                    });
                }
